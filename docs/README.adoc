...
:gitplant: https://www.plantuml.com/plantuml/proxy?src=https://raw.githubusercontent.com/DBuret/journal/master/
...
image::{gitplant}/goslin-class-diagram.puml[Goslin 2.0 Object Model]
