...
image:goslin-webapp-form-01.png[goslin web application submission
form for text files with one lipid name per row.]

image:goslin-webapp-form-02.png[goslin web application submission
form for user-defined lipid names.]

image:goslin-webapp-form-02a.png[goslin web application submission
form for user-defined lipid names provides feedback for unknown or
unsupported names and parts thereof.]

image:goslin-webapp-result-03.png[Parsing results are displayed as
...
image:goslin-webapp-result-detail-04.png[Each result card displays
...
Figure #fig:goslin-webapp-rest-05.png[[fig:goslin-webapp-rest-05]]). To
illustrate its usage, we will briefly show a small example how a user
can access the rest api with a standard http client.

image:goslin-webapp-rest-05.png[The goslin web application provides
